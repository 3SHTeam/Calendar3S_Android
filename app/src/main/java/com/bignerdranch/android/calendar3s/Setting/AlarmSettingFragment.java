...
public class AlarmSettingFragment extends Fragment implements MainActivity.onKeyBackPressedListener{
    private ScheduleManager SM;

    public AlarmSettingFragment newInstance(){
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_alarm_setting,container,false);
    ...
    public void onAttach(Context context) {
        ...
        Log.i("backKey","AlarmSetting onAttach");
    }
}
